  ...
  return (
    <div className="bg-[#001220] text-white py-6">
      ...
      <div className="grid md:grid-cols-2 xl:grid-cols-3">
        <div className=" grid justify-items-center py-5 mb-8  border-2  rounded-md mx-auto  shadow-md  w-5/6">
        ...
        <div className=" grid justify-items-center py-5 mb-8 rounded-md mx-auto  border-2   shadow-md  w-5/6">
