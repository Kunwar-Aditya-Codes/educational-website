...
const Vision = () => {
  return (
    <div className="bg-[url('images/banner.png')] bg-blend-color bg-black bg-opacity-[0.78] text-white bg-cover bg-no-repeat bg-center p-4 text-justify">
      <p className="text-2xl lg:text-4xl lg:w-1/2 lg:py-4 px-3 font-semibold md:w-2/3 mx-auto">
        Our vision is to create a world of opportunities in which the students
        could explore and identify their domain of passion and transform it into
        a dream and booming career.
      </p>
      <br />
      <p className="md:w-2/3 mx-auto py-2 px-3 lg:w-1/2 text-xl xl:w-1/3">
        * Help students to do their academic projects incorporate environment
        enabling them to analyze if the theoretical aspects they learned in
