  ...
  return (
    <div className="mt-12">
      ...
      <div className="text-justify w-4/5 mx-auto">
        ...
        <p className="text-lg">
          We offer in various departments such as Computer Science and
          Engineering, Information Technology, Networking, Communication, Bio
          Medical, Electronics, Electrical.
        </p>
      </div>
      <div className=" ">
      ...
      <div className="text-justify w-4/5 mx-auto mt-10">
        ...
        <p className="">
          We are specialized consultancy that delivers clear doctoral solutions
          to Ph.D. aspirants. We invite students to develop and significantly
          contribute to original research areas. We direct the students to
          identify the latest and unique research topics that encourage them to
          pursue their Ph.D./Research project with ease. We continuously
          motivate the students to do the research independently by providing
          the necessary tools & technologies. We are your best friend, your
          editor, your search engine is there to take you to a new
          state-of-the-art research with a wealth of experience. What you want
          out of the process and what you are going to get out of the process is
          well-defined, and indeed it is easily planned by our domain experts in
          which you are registered. “We believe our success is a reflection of
          our reputation”. We will identify a timeline for your work based on
          your deadline, and our experts will provide the support accordingly in
          a well-timed manner until the work is completed. Our business is to
          guide students to move beyond being passive recipients of knowledge to
          become knowledge builders, capable of creative and innovative
          solutions to problems.
        </p>
        <p className="mt-5">
          The guidance program consists of many experts in the research field,
          researchers on a particular technology domain, industry professionals,
          programmers and content writers. This program provides an opportunity
          for candidates to expand their capabilities in research, development
          and technical writing. We share our expertise to improve your
          knowledge and skill level to satisfy the university regulations. We
          work closely with research communities, identifying challenges,
          sharing findings, and continue exploring possibilities for the future
          and a variety of research directions.
        </p>
      </div>
      <div className="text-justify w-4/5 mx-auto mt-10">
        <h1 className="text-center text-4xl font-semibold text-teal-600 underline py-5">
      ...
      <div className="text-justify w-4/5 mx-auto mt-10">
        ...
        <div className="text-lg">
          <p className="mt-2 font-medium bg-teal-500 rounded-md p-2 text-center text-white">
